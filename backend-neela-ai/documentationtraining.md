...
**File Notebook Utama**: [`backend-neela-ai/train_rf_fix_v4_v3.ipynb`](file:///d:/aquaagent-web/backend-neela-ai/train_rf_fix_v4_v3.ipynb)  
**File Backend Integrasi**: [`backend-neela-ai/appv2.py`](file:///d:/aquaagent-web/backend-neela-ai/appv2.py)  
**Model Output Utama**: [`aquaagent_rf_v4_v3.pkl`](file:///d:/aquaagent-web/backend-neela-ai/aquaagent_rf_v4_v3.pkl) | [`rf_features_v4_v3.pkl`](file:///d:/aquaagent-web/backend-neela-ai/rf_features_v4_v3.pkl)  
